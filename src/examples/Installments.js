...
class Installments extends Component {
    ...
    sendData(){
        ...
        this.state.ReactNPS.setAmount('120050');
        this.state.ReactNPS.setCountry('ARG');
        this.state.ReactNPS.setCurrency('032');
        ...
        let result = this.state.ReactNPS.getInstallmentsOptions(data);
        this.setState({
            result: result
        });
    }
